/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f448ebdb11b05b686d5a73387c109e8c)
// Runtime types generated with workerd@1.20250424.0 2025-04-27
declare namespace Cloudflare {
	interface Env {
		GLOBAL_TOKEN: "test";
		GLOBAL_SECRET: "test";
		WebSocketServer: DurableObjectNamespace<
...
declare module "cloudflare:workers" {
		...
		implements Rpc.DurableObjectBranded
	{
		...
		initializeWebSocket?(request: Request): Response | Promise<Response>;
		alarm?(alarmInfo?: AlarmInvocationInfo): void | Promise<void>;
		webSocketMessage?(
			ws: WebSocket,
			message: string | ArrayBuffer,
