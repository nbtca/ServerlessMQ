...
function yr(e, t, n, r, l) {
	...
	if (((o = 0), (r = r === "" ? "." : r + ":"), Io(e)))
		...
		for (e = s.call(e), i = 0; !(u = e.next()).done; )
			(u = u.value), (s = r + wl(u, i++)), (o += yr(u, t, n, s, l));
	else if (u === "object")
		throw (
			((t = String(e)),
			Error(
...
L.StrictMode = uf;
L.Suspense = cf;
L.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = gf;
L.act = qi;
...
var Sf = el,
	...
	_f = Sf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function bi(e, t, n) {
	...
	for (r in t) Cf.call(t, r) && !xf.hasOwnProperty(r) && (l[r] = t[r]);
	if (e && e.defaultProps)
			...
			e: for (var H = 0, X = C.length, qn = X >>> 1; H < qn; ) {
				...
				if (0 > l(gl, z))
					ht < X && 0 > l(bn, gl)
						? ((C[H] = bn), (C[ht] = z), (H = ht))
						: ((C[H] = gl), (C[vt] = z), (H = vt));
				else if (ht < X && 0 > l(bn, z)) (C[H] = bn), (C[ht] = z), (H = ht);
				else break e;
			}
		}
		return N;
	...
	function d(C) {
		for (var N = n(f); N !== null; ) {
			if (N.callback === null) r(f);
				...
				r(f), (N.sortIndex = N.expirationTime), t(s, N);
			else break;
			N = n(f);
		}
	}
	...
	function E(C, N) {
		...
		try {
			...
			if (m !== null) var qn = !0;
				...
				var vt = n(f);
				vt !== null && yl(h, vt.startTime - N), (qn = !1);
			}
			return qn;
		} finally {
			(m = null), (p = z), (g = !1);
			...
			return (
				...
				z > H
					? ((C.sortIndex = z),
						...
						n(s) === null &&
							C === n(f) &&
							(S ? (c(P), (P = -1)) : (S = !0), yl(h, z - H)))
					: ((C.sortIndex = X), t(s, C), w || g || ((w = !0), hl(E))),
				C
			);
		}),
...
var Xe = Nf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function $f(e, t, n, r, l, u, o, i, s) {
	(En = !1), (Tr = null), jf.apply(Uf, arguments);
}
...
function ks(e) {
	return (e = Vf(e)), e !== null ? Es(e) : null;
}
function Es(e) {
...
var Cs = he.unstable_scheduleCallback,
	...
	Bf = he.unstable_shouldYield,
	Hf = he.unstable_requestPaint,
	Q = he.unstable_now,
	Qf = he.unstable_getCurrentPriorityLevel,
	Gu = he.unstable_ImmediatePriority,
	_s = he.unstable_UserBlockingPriority,
	Or = he.unstable_NormalPriority,
	Wf = he.unstable_LowPriority,
...
var Te = Math.clz32 ? Math.clz32 : Gf,
	Yf = Math.log,
	Xf = Math.LN2;
function Gf(e) {
...
function ec(e, t, n, r, l) {
	switch (t) {
		...
		case "gotpointercapture":
			return (
				(u = l.pointerId), Dn.set(u, cn(Dn.get(u) || null, e, t, n, r, l)), !0
			);
	}
	return !1;
}
...
function wr(e) {
	...
	for (var t = e.targetContainers; 0 < t.length; ) {
		...
		} else return (t = Zn(n)), t !== null && Ju(t), (e.blockedOn = n), !1;
		t.shift();
	}
	return !0;
}
...
function dn(e, t) {
	e.blockedOn === t &&
		...
		au ||
			((au = !0),
			he.unstable_scheduleCallback(he.unstable_NormalPriority, tc)));
}
function In(e) {
	function t(l) {
		return dn(l, e);
...
function qu(e, t, n, r) {
	if (Dr) {
		...
		else if ((Yo(e, r), t & 4 && -1 < bf.indexOf(e))) {
			for (; l !== null; ) {
				var u = Zn(l);
				if (
					(u !== null && zs(u),
...
var Ir = null;
function fu(e, t, n, r) {
	if (((Ir = null), (e = Xu(r)), (e = wt(e)), e !== null))
...
var ln = {
	...
	nl = A({}, Gn, {
		...
		movementX: function (e) {
			return "movementX" in e
				...
				: (e !== pn &&
						(pn && e.type === "mousemove"
							? ((xl = e.screenX - pn.screenX), (Pl = e.screenY - pn.screenY))
							: (Pl = xl = 0),
						(pn = e)),
					xl);
		},
	...
	Zo = ge(nl),
	uc = A({}, nl, { dataTransfer: 0 }),
	oc = ge(uc),
	ic = A({}, Gn, { relatedTarget: 0 }),
	Nl = ge(ic),
	sc = A({}, ln, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	ac = ge(sc),
	fc = A({}, ln, {
...
var yc = A({}, Gn, {
	...
	kc = ge(Sc),
	Ec = A({}, ln, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	Cc = ge(Ec),
	_c = A({}, nl, {
		deltaX: function (e) {
...
var Nc = Qe && "TextEvent" in window && !Cn,
	Is = Qe && (!no || (Cn && 8 < Cn && 11 >= Cn)),
	bo = " ",
	ei = !1;
function Fs(e, t) {
	switch (e) {
...
var $c = Qe && "documentMode" in document && 11 >= document.documentMode,
	It = null,
	cu = null,
	xn = null,
	du = !1;
...
for (var Rl = 0; Rl < ii.length; Rl++) {
	var Ol = ii[Rl],
		Ac = Ol.toLowerCase(),
		Vc = Ol[0].toUpperCase() + Ol.slice(1);
	dt(Ac, "on" + Vc);
}
...
var Sn =
	...
	Bc = new Set("cancel close invalid load scroll toggle".split(" ").concat(Sn));
function si(e, t, n) {
	...
	ws(function () {
		...
		e: {
			...
			if (p !== void 0) {
				...
				for (var a = f, d; a !== null; ) {
					...
					if (
						(d.tag === 5 &&
							h !== null &&
							((d = h),
							c !== null && ((h = On(a, c)), h != null && S.push($n(a, h, d)))),
						F)
					)
						break;
					a = a.return;
				...
				0 < S.length &&
					((p = new g(p, w, null, n, v)), m.push({ event: p, listeners: S }));
			}
		}
		if (!(t & 7)) {
			e: {
			...
			P &&
				...
				(_ = Fr(f, P)),
				0 < _.length &&
					((P = new Jo(P, e, null, n, v)),
					m.push({ event: P, listeners: _ }),
					x ? (P.data = x) : ((x = js(n)), x !== null && (P.data = x)))),
				(x = Nc ? zc(e, n) : Lc(e, n)) &&
...
function Fr(e, t) {
	for (var n = t + "Capture", r = []; e !== null; ) {
		...
		l.tag === 5 &&
			...
			((l = u),
			(u = On(e, n)),
			u != null && r.unshift($n(e, u, l)),
			(u = On(e, t)),
			u != null && r.push($n(e, u, l))),
			(e = e.return);
	}
	return r;
}
...
function ai(e, t, n, r, l) {
	for (var u = t._reactName, o = []; n !== null && n !== r; ) {
		...
		i.tag === 5 &&
			...
			((i = f),
			l
				? ((s = On(n, u)), s != null && o.unshift($n(n, s, i)))
				: l || ((s = On(n, u)), s != null && o.push($n(n, s, i)))),
			(n = n.return);
	}
...
var hu = typeof setTimeout == "function" ? setTimeout : void 0,
	...
	Kc =
		typeof queueMicrotask == "function"
			...
			: typeof ci < "u"
				? function (e) {
						return ci.resolve(null).then(e).catch(Yc);
					}
				: hu;
function Yc(e) {
	setTimeout(function () {
...
var un = Math.random().toString(36).slice(2),
	...
	yu = "__reactEvents$" + un,
	Xc = "__reactListeners$" + un,
	Gc = "__reactHandles$" + un;
function wt(e) {
	var t = e[Ie];
	if (t) return t;
...
function mt() {
	if (!Fl && Ae !== null) {
		...
		try {
			...
			throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Gu, mt), l);
		} finally {
			(O = t), (Fl = !1);
		}
	}
	...
	switch (e.tag) {
			...
			return (
				(t =
					t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
						...
						: t),
				t !== null
					? ((e.stateNode = t), (ve = e), (me = ut(t.firstChild)), !0)
					: !1
			);
		case 6:
			return (
		...
		case 13:
			return (
				...
				t !== null
					? ((n = xt !== null ? { id: Ve, overflow: Be } : null),
						(e.memoizedState = {
							dehydrated: t,
							treeContext: n,
...
var Jc = Xe.ReactCurrentBatchConfig;
function mn(e, t, n) {
	if (
...
function na(e) {
	...
	function s(c, a, d, h) {
		...
		return E === Mt
			...
			: a !== null &&
				...
				: ((h = zr(d.type, d.key, d.props, null, c.mode, h)),
					(h.ref = mn(c, a, d)),
					(h.return = c),
					h);
	}
	function f(c, a, d, h) {
		return a === null ||
			...
			? ((a = Ql(d, c.mode, h)), (a.return = c), a)
			: ((a = l(a, d.children || [])), (a.return = c), a);
	}
	function v(c, a, d, h, E) {
		return a === null || a.tag !== 7
			? ((a = Ct(d, c.mode, h, E)), (a.return = c), a)
			: ((a = l(a, d)), (a.return = c), a);
	}
	function m(c, a, d) {
			...
			switch (d.$$typeof) {
				case tr:
					e: {
						...
						d.type === Mt
							? ((a = Ct(d.props.children, c.mode, h, d.key)),
								(a.return = c),
								(c = a))
							: ((h = zr(d.type, d.key, d.props, null, c.mode, h)),
								(h.ref = mn(c, a, d)),
				...
				case Ot:
					e: {
						...
						(a = Ql(d, c.mode, h)), (a.return = c), (c = a);
					}
					return o(c);
				case Ze:
...
function sa(e, t) {
	...
	if (
		...
		(r = r.queue),
		wo(ca.bind(null, n, r, e), [e]),
		r.getSnapshot !== t || u || (G !== null && G.memoizedState.tag & 1))
	) {
		if (
			((n.flags |= 2048),
			Wn(9, fa.bind(null, n, r, l, t), void 0, null),
			Z === null)
		)
			throw Error(y(349));
		Pt & 30 || aa(n, t, l);
...
function ka(e, t, n) {
	return Pt & 21
		? (Oe(n, t) || ((n = Ps()), ($.lanes |= n), (Nt |= n), (e.baseState = !0)),
			t)
...
function td(e, t, n) {
	...
	if (Ca(e)) _a(t, l);
		...
		(n = la(e, t, l, r)),
			n !== null && ((l = ue()), Re(n, e, r, l), xa(n, t, r));
	}
}
function Ca(e) {
	var t = e.alternate;
	...
	nd = {
		...
		useSyncExternalStore: function (e, t, n) {
			...
			return (
				...
				(r.flags |= 2048),
				Wn(9, fa.bind(null, r, u, n, t), void 0, null),
				n
			);
		},
		useId: function () {
...
function Cu(e, t, n, r) {
	...
	typeof u == "object" && u !== null
		? (l.context = Ce(u))
		: ((u = ce(t) ? _t : re.current), (l.context = Jt(e, u))),
	...
	return (
		...
		e !== null && !ae
			? ((t.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				Ye(e, t, l))
			: (j && n && lo(t), (t.flags |= 1), le(e, t, r, l), t.child)
	);
}
	...
	return (
		...
		e !== null && !ae
			? ((t.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				Ye(e, t, l))
			: (j && r && lo(t), (t.flags |= 1), le(e, t, n, l), t.child)
	);
}
function Li(e, t, n, r, l) {
	...
	if ((Xt(t, l), t.stateNode === null))
		xr(e, t), Pa(t, n, r), Cu(t, n, r, l), (r = !0);
	else if (e === null) {
		var o = t.stateNode,
			i = t.memoizedProps;
		o.props = i;
...
function Ma(e, t, n) {
	...
	if (u) {
		...
		return (
			...
			i !== null ? (u = at(i, u)) : ((u = Ct(u, o, n, null)), (u.flags |= 2)),
			(u.return = t),
			(r.return = t),
			(r.sibling = u),
			(t.child = r),
...
function id(e, t, n, r, l, u, o) {
	if (n)
		return t.flags & 256
			? ((t.flags &= -257), (r = Vl(Error(y(422)))), pr(e, t, o, r))
			: t.memoizedState !== null
	...
	if (((i = (o & e.childLanes) !== 0), ae || i)) {
		...
		return No(), (r = Vl(Error(y(421)))), pr(e, t, o, r);
	}
	return l.data === "$?"
		? ((t.flags |= 128),
			(t.child = e.child),
...
function ad(e, t, n) {
	...
	switch ((uo(t), t.tag)) {
		...
		case 4:
			return (
				en(), Lu(e, t), e === null && Un(t.stateNode.containerInfo), te(t), null
			);
		case 10:
...
function Ua(e) {
	...
	t !== null && ((e.alternate = null), Ua(t)),
		...
		e.tag === 5 &&
			((t = e.stateNode),
			t !== null &&
				(delete t[Ie], delete t[An], delete t[yu], delete t[Xc], delete t[Gc])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function de(e, t) {
	...
	if (r === 0)
		...
		if ((n != null && Ko(n), t === 1))
			e.tag === 0 ? Zc(Ui.bind(null, e)) : qs(Ui.bind(null, e)),
				Kc(function () {
					!(R & 6) && mt();
				}),
				(n = null);
...
function Ha(e, t) {
	...
	if (r & 30 || r & e.expiredLanes || t) t = Jr(e, r);
		...
		R |= 2;
		var u = Wa();
		(Z !== e || q !== t) && (($e = null), (nn = Q() + 500), Et(e, t));
		do
			try {
				yd();
				break;
	...
	if (t !== 0) {
		if (
			...
			throw ((n = Kn), Et(e, 0), be(e, r), de(e, Q()), n);
		if (t === 6) be(e, r);
		else {
			if (
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						...
						e.timeoutHandle = hu(gt.bind(null, e, se, $e), t);
						break;
					}
					gt(e, se, $e);
					break;
				case 4:
					...
					if (
						...
						e.timeoutHandle = hu(gt.bind(null, e, se, $e), r);
						break;
					}
					gt(e, se, $e);
					break;
	...
	return de(e, Q()), e.callbackNode === n ? Ha.bind(null, e) : null;
}
function Fu(e, t) {
	var n = zn;
	return (
...
function Ui(e) {
	...
	if (n === 1) throw ((n = Kn), Et(e, 0), be(e, t), de(e, Q()), n);
...
function Et(e, t) {
	...
	if ((n !== -1 && ((e.timeoutHandle = -1), Wc(n)), W !== null))
...
function Jr(e, t) {
	...
	while (!0);
	if ((so(), (R = n), (Xr.current = r), W !== null)) throw Error(y(261));
	return (Z = null), (q = 0), Y;
}
function hd() {
	for (; W !== null; ) Ka(W);
...
function wd(e, t, n) {
	...
	r !== null && r.delete(t),
		...
		Z === e &&
			(q & n) === n &&
			(Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > Q() - _o)
				? Et(e, 0)
				: (Co |= n)),
		de(e, t);
}
...
Ga = function (e, t, n) {
	...
	else (ae = !1), j && t.flags & 1048576 && bs(t, Vr, t.index);
			...
			return (
				...
				l.$$typeof === void 0
					? ((t.tag = 1),
						...
						Cu(t, r, e, n),
						(t = Pu(null, t, r, !0, u, n)))
					: ((t.tag = 0), j && u && lo(t), le(null, t, l, n), (t = t.child)),
				t
			);
		case 16:
			r = t.elementType;
...
function zr(e, t, n, r, l, u) {
	...
	if (((r = e), typeof e == "function")) zo(e) && (o = 1);
		...
		e: switch (e) {
			...
			case Yl:
				return (
					(e = ke(12, n, t, l | 2)), (e.elementType = Yl), (e.lanes = u), e
				);
			case Xl:
	...
	return (
		(t = ke(o, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = u), t
	);
}
function Ct(e, t, n, r) {
	...
	switch (e.tag) {
		case 3:
			...
			if (t.current.memoizedState.isDehydrated) {
				...
				n !== 0 &&
					(Zu(t, n | 1), de(t, Q()), !(R & 6) && ((nn = Q() + 500), mt()));
			}
			break;
		case 13:
			zt(function () {
...
ys = xo;
gs = zt;
var zd = { usingClientEntryPoint: !1, Events: [Zn, jt, ul, vs, hs, xo] },
	hn = {
	...
	Ld = {
		...
		findFiberByHostInstance: hn.findFiberByHostInstance || Pd,
...
function Rd() {
	const [e, t] = el.useState(0);
	return Ue.jsx("div", {
		className: "App",
		children: Ue.jsxs("header", {
			className: "App-header",
			children: [
				Ue.jsx("h1", { children: "ServerlessMQ Frontend" }),
				Ue.jsx("p", { children: "欢迎使用 ServerlessMQ 消息队列系统" }),
				Ue.jsxs("div", {
					className: "card",
					children: [
						Ue.jsxs("button", {
						...
						Ue.jsx("p", { children: "这是一个基于React的单页应用示例" }),
					],
				}),
			],
		}),
...
Wl.createRoot(document.getElementById("root")).render(
	Ue.jsx(wf.StrictMode, { children: Ue.jsx(Rd, {}) })
);
